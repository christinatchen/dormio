...
function duringSleep(){
  ...
  var timeBetweenInput = parseInt($('#time-between-sleep').val());

  //convert minute input to seconds
  var timeBetween = timeBetweenInput * 60;
...
function endSession() {
  ...
  //zip folders
  var user = $("#name").val() 
  var subject = $("#dream-subject").val()
  var prefix = user + "_" + subject;
  var zip = new JSZip();
